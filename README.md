   ...
   Overall confidence results for digit "1", "2", "3" and "0" recognition is now 60% but what matters
the most are the training set vs test set and the kernels applied
